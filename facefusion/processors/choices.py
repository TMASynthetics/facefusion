...
face_debugger_items : List[FaceDebuggerItem] = [ 'bounding-box', 'fran-box', 'face-landmark-5', 'face-landmark-5/68', 'face-landmark-68', 'face-landmark-68/5', 'face-mask', 'face-detector-score', 'face-landmarker-score', 'age', 'gender', 'race' ]
...
age_modifier_source_age_range : Sequence[int] = create_int_range(0, 90, 1)
age_modifier_target_age_range : Sequence[int] = create_int_range(0, 90, 1)
age_modifier_stride_range : Sequence[int] = [16, 32, 64, 128, 256, 512]
